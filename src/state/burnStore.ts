    ...
    const { liquidityPercentage, liquidityValue0, liquidityValue1 } = useMemo(() => {
        ...
        const liquidityValue0 =
            currency0 && discountedAmount0
                ? CurrencyAmount.fromRawAmount(asWNative ? currency0 : unwrappedToken(currency0), discountedAmount0)
                : undefined;
        const liquidityValue1 =
            currency1 && discountedAmount1
                ? CurrencyAmount.fromRawAmount(asWNative ? currency1 : unwrappedToken(currency1), discountedAmount1)
                : undefined;
